...
final class SpdyReader implements Closeable {
	...
	/**
	 * Send the next frame to {@code handler}. Returns true unless there are no more frames on the stream.
	 */
	...
	public interface Handler {
		...
		void synStream(int flags, int streamId, int associatedStreamId, int priority, int slot, List<String> nameValueBlock);
