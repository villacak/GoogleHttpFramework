...
final class Settings {
	/**
	 * From the spdy/3 spec, the default initial window size for all streams is 64 KiB. (Chrome 25 uses 10 MiB).
	 */
	...
	/**
	 * Writes {@code other} into this. If any setting is populated by this and {@code other}, the value and flags from {@code other} will be kept.
	 */
