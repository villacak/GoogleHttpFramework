...
public interface IncomingStreamHandler {
	...
	/**
	 * Handle a new stream from this connection's peer. Implementations should respond by either {@link SpdyStream#reply replying to the stream} or
	 * {@link SpdyStream#close closing it}. This response does not need to be synchronous.
	 */
