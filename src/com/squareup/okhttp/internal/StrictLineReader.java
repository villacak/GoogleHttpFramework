 ...
 * {@code EOFException}. Unterminated line at end of input is invalid and will be ignored, the caller may use {@code hasUnterminatedLine()} to detect
 * it after catching the {@code EOFException}.
 * 
 ...
 * {@link BufferedReader} which in conjunction with {@link InputStreamReader} provides similar functionality, this class uses different end-of-input
 * reporting and a more restrictive definition of a line.
 * 
 * This class supports only charsets that encode '\r' and '\n' as a single byte with value 13 and 10, respectively, and the representation of no other
 * character contains these values. We currently check in constructor that the charset is one of US-ASCII, UTF-8 and ISO-8859-1. The default charset
 * is US_ASCII.
 */
public class StrictLineReader implements Closeable {
	 ...
	 *            the {@code InputStream} to read data from.
	 * @param charset
	 *            the charset used to decode data. Only US-ASCII, UTF-8 and ISO-8859-1 is supported.
	 * @throws NullPointerException
	 ...
	 * @throws IOException
	 *             for underlying {@code InputStream} errors or conversion error.
	 * @throws EOFException
	 *             for the end of source stream.
	 */
