...
public final class HttpsURLConnectionImpl extends HttpsURLConnection {
	...
	private SSLSocket getSslSocket() {
		...
		return delegate.httpEngine instanceof HttpsEngine ? ((HttpsEngine) delegate.httpEngine).sslSocket : null; // Not HTTPS! Probably an https://
																													// to http:// redirect.
	}
	...
	public static final class HttpsEngine extends HttpEngine {
		/**
		 * Stash of HttpsEngine.connection.socket to implement requests like {@link #getCipherSuite} even after the connection has been recycled.
		 */
		 ...
		 */
		public HttpsEngine(HttpURLConnectionImpl policy, String method, RawHeaders requestHeaders, Connection connection,
