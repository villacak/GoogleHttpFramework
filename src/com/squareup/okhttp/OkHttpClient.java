...
public final class OkHttpClient {
	...
	/**
	 * Sets the HTTP proxy that will be used by connections created by this client. This takes precedence over {@link #setProxySelector}, which is
	 * only honored when this proxy is null (which it is by default). To disable proxy use completely, call {@code setProxy(Proxy.NO_PROXY)}.
	 */
	...
	/**
	 * Sets the proxy selection policy to be used if no {@link #setProxy proxy} is specified explicitly. The proxy selector may return multiple
	 * proxies; in that case they will be tried in sequence until a successful connection is established.
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * If unset, the {@link ResponseCache#getDefault() system-wide default} response cache will be used.
	 */
	 ...
	 * 
	 * <p>
	 * If unset, the {@link HttpsURLConnection#getDefaultHostnameVerifier() system-wide default} hostname verifier will be used.
	 */
	...
	/**
	 * Returns a copy of this OkHttpClient that uses the system-wide default for each field that hasn't been explicitly configured.
	 */
